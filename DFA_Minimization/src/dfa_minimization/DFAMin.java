...
public class DFAMin {
    ...
    public DFAMin() {
        ...
        System.out.print("Enter Number of DFAs: ");
    ...
    private DFA readDFA(Scanner inFile) {
        System.out.print("Enter Number of states and alphabets on each state: (space separated) ");
        String[] line = inFile.nextLine().split(" ");
        int numStates = Integer.parseInt(line[0]);
        int numAlpha = Integer.parseInt(line[1]);

        System.out.print("Enter Quatity of Final States followed by Number of Final States: (space separated) ");
